        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo-color.png" alt="" height="17">
                    </span>
                </a>

                <a href="index" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="assets/images/logo-icon.svg" alt="" height="35">
                    </span>
                    <span class="logo-lg">
                        <img src="assets/images/logo-wilko.svg" alt="" height="30">
                    </span>
                </a>
            </div>

            <button type="button" class="btn btn-sm px-3 font-size-16 header-item waves-effect" id="vertical-menu-btn">
                <i class="fa fa-fw fa-bars text-danger"></i>
            </button>
        ...
        <div class="d-flex">
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-0 mb-1">Subscription</h6>
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1">your subscription finished in 10 days, remember to renew it.</p>
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-0 mb-1">Meeting</h6>
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1">Tom Ford as arrived has Front Desk.</p>
                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i> 45 min ago</p>
                                    </div>
                                </div>
                            </div>
                        </a>
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-0 mb-1">Delivery</h6>
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1">You have a delivery via UPS, signature required at Front Desk.</p>
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                <img src="assets/images/users/avatar-4.jpg"
                                    class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                <div class="media-body">
                                    <h6 class="mt-0 mb-1">Visit</h6>
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1">Salena Agbonon is here to see you.</p>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ url('images').'/'.session()->get('user_picture') }}"
                        alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href=""><i class="bx bx-wallet font-size-16 align-middle mr-1"></i> My Meetings</a>
                    <a class="dropdown-item d-block" href="#"><i class="bx bx-wrench font-size-16 align-middle mr-1"></i> Settings</a>
                    <a class="dropdown-item" href="auth-lock-screen"><i class="bx bx-lock-open font-size-16 align-middle mr-1"></i> Lock screen</a>
